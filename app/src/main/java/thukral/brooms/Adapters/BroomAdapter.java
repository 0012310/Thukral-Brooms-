...
public class BroomAdapter extends RecyclerView.Adapter<BroomAdapter.ViewHolder> {
    private int flag = 0;
    private click cl;
    Context context;
    ArrayList<modelAllBrooms> modelAllBroomsArrayList = new ArrayList<>();

    public BroomAdapter(Context context, ArrayList<modelAllBrooms> modelAllBroomsArrayList, Img_addWish_Onclick img_addWish_onclick) {
