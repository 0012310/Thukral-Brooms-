...
public class BroomAdapter_cum extends RecyclerView.Adapter<BroomAdapter_cum.ViewHolder> {
    private int flag = 0;
    private BroomsActivity_Cum cl;
    Context context;
    ArrayList<modelAllBrooms> modelAllBroomsArrayList = new ArrayList<>();

    public BroomAdapter_cum(Context context, ArrayList<modelAllBrooms> modelAllBroomsArrayList, Img_addWish_Onclick img_addWish_onclick) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int i) {
        ...
        String data = modelAllBroomsArrayList.get(i).getWishlist();
        ...
        holder.ic_wishlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag == 0) {
                    ADD_WishList(modelAllBroomsArrayList.get(i).getId(), holder);
                    flag = 1;
