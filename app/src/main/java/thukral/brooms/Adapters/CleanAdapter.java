...
public class CleanAdapter extends RecyclerView.Adapter<CleanAdapter.ViewHolder> {
    ...
    public CleanAdapter(Context context, ArrayList<modelAllClean> modelAllCleanArrayList, Img_addWish_Onclick img_addWish_onclick) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CleanAdapter.ViewHolder viewHolder = new CleanAdapter.ViewHolder(layoutView);
        return viewHolder;
    }
