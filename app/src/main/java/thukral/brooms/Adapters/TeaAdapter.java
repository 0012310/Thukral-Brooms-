...
public class TeaAdapter extends RecyclerView.Adapter<TeaAdapter.ViewHolder> {
    private int flag = 0;
    private BroomAdapter.click cl;
    Context context;
    ArrayList<modelAllTea> modelAllTeaArrayList = new ArrayList<>();

    public TeaAdapter(Context context, ArrayList<modelAllTea> modelAllTeaArrayList, Img_addWish_Onclick img_addWish_onclick) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TeaAdapter.ViewHolder viewHolder = new TeaAdapter.ViewHolder(layoutView);
        return viewHolder;
    }
