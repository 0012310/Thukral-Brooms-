...
import thukral.brooms.Activities.TeaDetails;
...
public class TeaAdapter_cum extends RecyclerView.Adapter<TeaAdapter_cum.ViewHolder> {
    private int flag = 0;
    private TeaActivity_Cum cl;
    Context context;
    ArrayList<modelAllTea> modelAllTeaArrayList = new ArrayList<>();

    public TeaAdapter_cum(Context context, ArrayList<modelAllTea> modelAllTeaArrayList, Img_addWish_Onclick img_addWish_onclick) {
        this.context = context;
        this.modelAllTeaArrayList = modelAllTeaArrayList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TeaAdapter_cum.ViewHolder viewHolder = new TeaAdapter_cum.ViewHolder(layoutView);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int i) {
        ...
        holder.name.setText(modelAllTeaArrayList.get(i).getName());
        ...
        cl = (TeaActivity_Cum) context;

        String data = modelAllTeaArrayList.get(i).getWishlist();
        ...
        holder.ic_wishlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag == 0) {
                    ADD_WishList(modelAllTeaArrayList.get(i).getId(), holder);
                    flag = 1;
        ...
        holder.layout_item_parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, TeaDetails.class);
                intent.putExtra("PRO_ID",modelAllTeaArrayList.get(i).getId());
    ...
    public int getItemCount() {
        return modelAllTeaArrayList.size();
    }
