...
public class PochaAdapter extends RecyclerView.Adapter<PochaAdapter.ViewHolder> {

    private int flag = 0;
    private PochaActivity cl;
    Context context;
    ArrayList<modelAllPocha> modelAllPochas = new ArrayList<>();

    public PochaAdapter(Context context, ArrayList<modelAllPocha> modelAllPochas, Img_addWish_Onclick img_addWish_onclick) {
        this.context = context;
        this.modelAllPochas = modelAllPochas;
    }

    @NonNull
    @Override
    public PochaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_brooms, parent, false);
        PochaAdapter.ViewHolder viewHolder = new PochaAdapter.ViewHolder(layoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final PochaAdapter.ViewHolder holder, final int i) {
        ...
        holder.name.setText(modelAllPochas.get(i).getName());
        holder.tv_description.setText(modelAllPochas.get(i).getDescription());
        holder.sales_price.setText("Rs" + " " + modelAllPochas.get(i).getSales_price());
        ...
        String data = modelAllPochas.get(i).getWishlist();
        ...
        holder.ic_wishlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag == 0) {
                    ADD_WishList(modelAllPochas.get(i).getId(), holder);
                    flag = 1;
        ...
        holder.layout_item_parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("PRO_ID", modelAllPochas.get(i).getId());
    ...
    private void ADD_WishList(final String ID, final PochaAdapter.ViewHolder holder) {
